  ...
  const sections = [
    {
      ...
      images: [ritratti, eventi, altro, ritratti, eventi, altro],
    },
  ];
                        ...
                        <>
                          <div className="col-4" key={i}>
                            <img
                              ...
                              width="100%"
                              onClick={() =>
                                showPicture(i, section.sectionTitle)
                              }
                            />
                          </div>
                          {isOpen &&
                            _section === section.sectionTitle &&
                            photoIndex === i && (
                              <Lightbox
                                mainSrc={section.images[photoIndex]}
                                nextSrc={
                                  section.images[
                                    (photoIndex + 1) % section.images.length
                                  ]
                                }
                                prevSrc={
                                  section.images[
                                    (photoIndex + section.images.length - 1) %
